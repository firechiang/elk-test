...
import com.firecode.elktest.biz.common.ApiDataTableResponse;
import com.firecode.elktest.biz.common.ApiResponse;
import com.firecode.elktest.biz.common.HouseOperation;
...
import com.firecode.elktest.biz.domain.dto.QiNiuPutRet;
...
public class AdminController {
    ...
    public ApiResponse addHouse(@Valid @ModelAttribute("form-house-add") HouseForm houseForm, BindingResult bindingResult) {
        ...
        if (houseForm.getPhotos() == null || houseForm.getCover() == null) {
        	houseForm.setCover("https://images.contentstack.io/v3/assets/bltefdd0b53724fa2ce/blt850b5bd506c6b3ce/5d0cfe28d8ff351753cbf2ad/logo-elastic-search-color-64.svg");
